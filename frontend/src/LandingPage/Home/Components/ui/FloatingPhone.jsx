 ...
 const FloatingPhone = () => {
  return (
    <div
      ...
      className="rounded-[24px] bg-green-800"
    >
      <motion.div
        initial={{
...
const HeaderBar = () => {
  return (
    <>
      <div className="absolute left-[50%] top-2.5 z-10 h-2 w-16 -translate-x-[50%] rounded-md "></div>
...
const Screen = () => {
  return (
    <div className="relative z-0 grid h-full w-full place-content-center overflow-hidden rounded-[20px] bg-white">
      ...
      <button className="absolute bottom-4 left-4 right-4 z-10 rounded-lg border-[1px] bg-white py-2 text-sm font-medium text-green-900 backdrop-blur">
        Contact Us
      </button>
